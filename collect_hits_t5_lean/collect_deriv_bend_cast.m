function collect_deriv_bend_cast(target_folder,rig, varargin)
...
name_folder = 'screen_scale_deriv_bend_cast_ness';
mkdir(name_folder);
cd(name_folder)
...
%    fprintf('%i\t %s\n', i, files(i).name); 
   ...
   globale_bend_cast_ness_first(i,:)                 = bend_cast_ness.deriv_S_norm';
   globale_bend_cast_ness_second(i,:)                = bend_cast_ness.deriv_S_norm_norm';
