function collect_bend(target_folder,rig, varargin)
...
name_folder = 'screen_scale_bendiness';
mkdir(name_folder);
cd(name_folder)
...
%    fprintf('%i\t %s\n', i, files(i).name); 
   ...
   globale_bendiness_first(i,:)                 = bendiness.S';
   globale_bendiness_second(i,:)                = bendiness.S_norm';
