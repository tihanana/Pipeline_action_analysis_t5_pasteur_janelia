function trx = give_correction_stop_to_global_states(trx)
...
for i = 1 : n_trx
   ...
   start_stop         = trx(i).start_stop{indice_stop};
   is_stop            = trx(i).is_stop; 
   border_elimination = trx(i).border_elimination;
   for j = 1 : length(is_stop)

       if is_stop(j) == -1
           if border_elimination(j) ==1
                global_state = rectify_border(global_state, start_stop, j, n_t);
           else 
                global_state = rectify_stop_between_states(global_state, start_stop, j);
           end
       end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function global_state = rectify_stop_between_states(global_state, start_stop, j)
