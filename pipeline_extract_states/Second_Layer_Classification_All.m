function trx = Second_Layer_Classification_All(trx, path_to_classifiers )
...
classifier          = [path_to_classifiers  'all_behaviours.mat'];
load(classifier);
trx                 = give_state_choreography_3_steps_all_at_once(trx, all_behaviours, index_all_behaviours);
