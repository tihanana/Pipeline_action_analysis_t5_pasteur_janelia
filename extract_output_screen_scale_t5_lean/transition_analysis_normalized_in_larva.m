function transitions = transition_analysis_normalized_in_larva(trx, t_start, t_stop, t_max)
...
[transition_globale_before , transition_globale_norm_before , nb_active_before, n_trx_before ] = Markov_transition_normalized_larva_global_during_time_window(trx, t_init,  t_start);
[transition_globale_during , transition_globale_norm_during , nb_active_during, n_trx_during ] = Markov_transition_normalized_larva_global_during_time_window(trx, t_start, t_stop);
[transition_globale_after  , transition_globale_norm_after , nb_active_after, n_trx_after ]    = Markov_transition_normalized_larva_global_during_time_window(trx, t_stop,  t_max);
...
[transition_after_start, transition_after_start_norm, nb_active_after_start, n_trx_after_start ] = Markov_transition_normalized_larva_global_during_time_window(trx, t_start - dt_before ,  t_just_after_start);
[transition_after_stop, transition_after_stop_norm, nb_active_after_stop, n_trx_after_stop ]     = Markov_transition_normalized_larva_global_during_time_window(trx, t_stop  - dt_before ,   t_just_after_stop);
...
save('transition_analysis_normalized_in_larva.mat', 'transitions', 'transitions_data' );
